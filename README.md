...
+ [Purpose](#purpose)
    ...
    + [AWS Systems Manager Parameter Store]()
        - [`/confluent_cloud_resource/consumer_kafka_client/java_client`](#confluent_cloud_resourceschema_registry_clusterjava_client)
        - [`/confluent_cloud_resource/producer_kafka_client/java_client`](#confluent_cloud_resourcekafka_clusterjava_client)
